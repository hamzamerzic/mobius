...
// The Artifacts zone: a simple list of a project's buildable outputs (website /
// latex), each opening in its own tab. Artifacts are created for you — a
  ...
  return (
    <section className="project-artifacts" aria-labelledby="project-artifacts-label">
      ...
      {artifactsQuery.isLoading ? (
        ...
        <p className="projects-empty project-artifacts__empty">No artifacts yet. Open a file’s ⋯ menu to build it as a website or PDF.</p>
      ) : (
