...
test('a project without a usable name falls back to "Project"', () => {
  assert.deepEqual(recentsProjectChip('chat', { id: 'c1', project: { id: 3 } }), { id: '3', name: 'Project' })
  assert.deepEqual(recentsProjectChip('chat', { id: 'c1', project: { id: 3, name: '   ' } }), { id: '3', name: 'Project' })
})
